...
<div class="min-h-screen w-full py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900 rounded">
  <div class="text-center">
    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-5xl md:text-6xl">
      ...
      <span class="block text-primary-600 dark:text-primary-400">Simple and Accessible</span>
    </h1>
